...
test_name = (
    ('QUIZ 1, ASSIGNMENT', 'QUIZ 1, ASSIGNMENT'),
    ('QUIZ 2, ASSIGNMENT', 'QUIZ 2, ASSIGNMENT'),
    ('QUIZ 3, ASSIGNMENT', 'QUIZ 3, ASSIGNMENT'),
    ('MIDTERM 1', 'MIDTERM 1'),
    ('MIDTERM 2', 'MIDTERM 1'),
    ('FINAL (SEE)', 'FINAL (SEE)'),
)
...
class MarksClass(models.Model):
    assign = models.ForeignKey(Assign, on_delete=models.CASCADE)
    name = models.CharField(max_length=50, choices=test_name, default='QUIZ 1, ASSIGNMENT')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='QUIZ 1, ASSIGNMENT')
                    sc.marks_set.create(name='QUIZ 2, ASSIGNMENT')
                    sc.marks_set.create(name='QUIZ 3, ASSIGNMENT')
                    sc.marks_set.create(name='MIDTERM 1')
                    sc.marks_set.create(name='MIDTERM 2')
                    sc.marks_set.create(name='FINAL (SEE)')
