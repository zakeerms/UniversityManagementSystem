...
def marks_list(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            sc.save()
            sc.marks_set.create(type='I', name='QUIZ 1, ASSIGNMENT')
            sc.marks_set.create(type='I', name='QUIZ 2, ASSIGNMENT')
            sc.marks_set.create(type='I', name='QUIZ 3, ASSIGNMENT')
            sc.marks_set.create(type='E', name='MIDTERM 1')
            sc.marks_set.create(type='E', name='MIDTERM 2')
            sc.marks_set.create(type='S', name='FINAL (SEE)')
        sc_list.append(sc)
