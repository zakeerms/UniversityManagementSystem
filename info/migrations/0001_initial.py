# Generated by Django 2.1.2 on 2019-11-09 09:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('QUIZ 1, ASSIGNMENT', 'QUIZ 1, ASSIGNMENT'), ('QUIZ 2, ASSIGNMENT', 'QUIZ 2, ASSIGNMENT'), ('QUIZ 3, ASSIGNMENT', 'QUIZ 3, ASSIGNMENT'), ('MIDTERM 1', 'MIDTERM 1'), ('MIDTERM 2', 'MIDTERM 2'), ('FINAL (SEE)', 'FINAL (SEE)')], default='QUIZ 1, ASSIGNMENT', max_length=50)),
